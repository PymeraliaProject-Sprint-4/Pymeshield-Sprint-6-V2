<template>
    ...
    <div style="display: flex; justify-content: center;">
        <button @click="redirectToCourses()" id=""
                                           ...
                                           <div hidden>
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    maxlength="50"
                                                    v-model="name_edit"
                                                    type="text" name="name_edit" id="name_edit"
                                            ...
                                            <div>
                                                ...
                                                <textarea
                                                    ...
                                                    type="text" name="description_edit" id="description_edit"
                                                    class="bg-gray-100 border-gray-300 focus:ring-orange-400 focus:border-orange-400 rounded-md w-full py-2 px-3 mb-4"/>
                                            </div>
                                            <div>
...
export default {
    ...
    async created() {
        const response = await axios.get('/course/hidden_data')
    ...
    methods: {
        ...
        updateCourse() {
            ...
            if ((this.name_edit && this.name_edit.length <= 50) && (this.description_edit && this.description_edit.length <= 255)){                // Codificación de los valores de los campos de texto
                this.sending = true;
                axios.put('/course/update_hidden/' + this.id, {
        ...
        deleteCourse(course) {
            ...
            this.sending = true;
            axios.get('/course/' + this.selectedCourse + '/unHide', {})
                .then(response => {
                    this.courses = response.data.courses;
                })
                .catch(error => {
...
import {AcademicCapIcon, TrashIcon, PencilSquareIcon, ArrowUpIcon, EyeIcon, EyeSlashIcon} from '@heroicons/vue/24/outline'
</script>
