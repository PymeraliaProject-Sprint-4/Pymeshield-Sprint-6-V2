...
export default {
    components: {
        ...
        AcademicCapIcon, Bars3Icon, CalendarDaysIcon, CurrencyEuroIcon, ViewColumnsIcon, DocumentDuplicateIcon, HomeIcon, QrCodeIcon, XMarkIcon, LanguageIcon, IdentificationIcon, WrenchScrewdriverIcon, ArrowLeftOnRectangleIcon, QueueListIcon, LifebuoyIcon, VueAvatar
    },
    data() {
        return {
