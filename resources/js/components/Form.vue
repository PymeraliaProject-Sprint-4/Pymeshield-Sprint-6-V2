        ...
        <form action="" id="questionnaire-form" method="POST" v-on:submit.prevent="saveTask()">
            ...
            <div class="grid gap-6 my-6">
                <div class="flex justify-center mt-5">
                    <div class="w-10/12">
                        <div>
                            <label class="block font-medium text-label text-gray-700" for="question">{{ $t('question')
                            }}</label>
                        </div>
                        <div>
                            <input
                                ...
                                type="text" name="question" id="question" v-model="pregunta" autofocus>
                        </div>
                ...
                <div class="flex justify-center">
                    <div class="w-10/12">
                        <div>
                            <label class="block font-medium text-label text-gray-700" for="description">{{
                                $t('question.description') }}</label>
                        </div>
                        <div>
                            <input
                                class="my-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6"
                                type="text" name="description" id="description" v-model="description" autofocus>
                        </div>
                ...
                <details class="pl-4">
                    ...
                    <div class="flex justify-center">
                        <div class="w-10/12">
                            <div>
                                <label class="block font-medium text-label text-gray-700" for="recommendation_true">{{
                                    $t('answer.reco') }}</label>
                            </div>
                            <div>
                                <input
                                    class="my-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6"
                                    type="text" name="recommendation_true" id="recommendation_true"
                                    v-model="recommendation_true" autofocus>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-center">
                        <div class="w-10/12">
                            <div>
                                <label class="block font-medium text-label text-gray-700" for="risk_true">{{
                                    $t('answer.risk') }}</label>
                            </div>
                            <select id="risk_true" name="risk_true" v-model="risk_true"
                                ...
                                <option v-for="risk in risks" :value="risk.id" :key="risk.id">{{ risk.name }}
                                </option>
                            </select>
                        </div>
                    </div>
                    <div class="flex justify-center">
                        <div class="w-10/12">
                            <div>
                                <label class="block font-medium text-label text-gray-700" for="intervention_true">{{
                                    $t('answer.inter') }}</label>
                            </div>
                            <select id="intervention_true" name="intervention_true" v-model="intervention_true"
                                class="my-2 block w-full rounded-md border-0 bg-white py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6">
                                <option value="" selected>{{ $t('messages.option') }}</option>
                    ...
                    <div class="flex justify-center">
                        <div class="w-10/12">
                            <div>
                                <label class="block font-medium text-label text-gray-700" for="measure_true">{{
                                    $t('answer.type') }}</label>
                            </div>
                            <select id="measure_true" name="measure_true" v-model="measure_true"
                                class="my-2 block w-full rounded-md border-0 bg-white py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6">
                                <option value="" selected>{{ $t('messages.option') }}</option>
                    ...
                    <div class="flex justify-center">
                        <div class="w-10/12">
                            <div>
                                <label class="block font-medium text-label text-gray-700" for="probability_true">{{
                                    $t('answer.prob') }}</label>
                            </div>
                            <select id="probability_true" name="probability_true" v-model="probability_true"
                                class="my-2 block w-full rounded-md border-0 bg-white py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6">
                                <option value="" selected>{{ $t('messages.option') }}</option>
                                <option v-for="probability in probabilities" :value="probability.id" :key="probability.id">
                                    {{ probability.name }}
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="flex justify-center">
                        <div class="w-10/12">
                            <div>
                                <label class="block font-medium text-label text-gray-700" for="impact_true">{{
                                    $t('answer.imp') }}</label>
                            </div>
                            <select id="impact_true" name="impact_true" v-model="impact_true"
                                class="my-2 block w-full rounded-md border-0 bg-white py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6">
                                <option value="" selected>{{ $t('messages.option') }}</option>
                                <option v-for="impact in impacts" :value="impact.id" :key="impact.id">{{ impact.name }}
                                </option>
                            </select>
                        </div>
                    </div>
                ...
                <details class="pl-4">
                    ...
                    <div class="flex justify-center">
                        <div class="w-10/12">
                            <div>
                                <label class="block font-medium text-label text-gray-700" for="recommendation_false">{{
                                    $t('answer.reco') }}</label>
                            </div>
                            <div>
                                <input
                                    class="my-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6"
                                    type="text" name="recommendation_false" id="recommendation_false"
                                    v-model="recommendation_false" autofocus>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-center">
                        <div class="w-10/12">
                            <div>
                                <label class="block font-medium text-label text-gray-700" for="risk_false">{{
                                    $t('answer.risk') }}</label>
                            </div>
                            <select id="risk_false" name="risk_false" v-model="risk_false"
                                class="my-2 block w-full rounded-md border-0 bg-white py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6">
                                <option value="" selected>{{ $t('messages.option') }}</option>
                                <option v-for="risk in risks" :value="risk.id" :key="risk.id">{{ risk.name }}
                                </option>
                    ...
                    <div class="flex justify-center">
                        <div class="w-10/12">
                            <div>
                                <label class="block font-medium text-label text-gray-700" for="intervention_false">{{
                                    $t('answer.inter') }}</label>
                            </div>
                            <select id="intervention_false" name="intervention_false" v-model="intervention_false"
                                class="my-2 block w-full rounded-md border-0 bg-white py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6">
                                <option value="" selected>{{ $t('messages.option') }}</option>
                                <option v-for="intervention in interventions" :value="intervention.id"
                                    :key="intervention.id">{{ intervention.name }}
                    ...
                    <div class="flex justify-center">
                        <div class="w-10/12">
                            <div>
                                <label class="block font-medium text-label text-gray-700" for="measure_false">{{
                                    $t('answer.reco') }}</label>
                            </div>
                            <select id="measure_false" name="measure_false" v-model="measure_false"
                                class="my-2 block w-full rounded-md border-0 bg-white py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6">
                                <option value="" selected>{{ $t('messages.option') }}</option>
                                <option v-for="type_measure in type_measures" :value="type_measure.id"
                                    :key="type_measure.id">{{ type_measure.name }}
                    ...
                    <div class="flex justify-center">
                        <div class="w-10/12">
                            <div>
                                <label class="block font-medium text-label text-gray-700" for="probability_false">{{
                                    $t('answer.prob') }}</label>
                            </div>
                            <select id="probability_false" name="probability_false" v-model="probability_false"
                                class="my-2 block w-full rounded-md border-0 bg-white py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6">
                                <option value="" selected>{{ $t('messages.option') }}</option>
                                <option v-for="probability in probabilities" :value="probability.id" :key="probability.id">
                                    {{ probability.name }}
                    ...
                    <div class="flex justify-center">
                        <div class="w-10/12">
                            <div>
                                <label class="block font-medium text-label text-gray-700" for="impact_false">{{
                                    $t('answer.imp') }}</label>
                            </div>
                            <select id="impact_false" name="impact_false" v-model="impact_false"
                                class="my-2 block w-full rounded-md border-0 bg-white py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6">
                                <option value="" selected>{{ $t('messages.option') }}</option>
                                <option v-for="impact in impacts" :value="impact.id" :key="impact.id">{{ impact.name }}
                                </option>
