<template>
    <h1 class="ml-7 mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl pt-4"><span
                                    ...
                                    <div class="sm:items-start">
                                        <div class="mt-3 text-center sm:mt-0 sm:mx-1 sm:text-left">
                                            ...
                                            <select v-model="course_id" id="course_id" name="course_id" required
                                                ...
                                                <option v-for="(course, key) in courses" :key="course.id"
                                                    :value="course.id">{{
                                                        course.name }}</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class=" sm:items-start">
                                        <div class="mt-3 text-center sm:mt-0 sm:mx-1 sm:text-left">
                                            ...
                                            <div>
                                                ...
                                                <textarea maxlength="254" v-model="description" type="text"
