        ...
        <tbody>
            ...
            <tr class="bg-orange-50 hover:bg-orange-100 text-center">
                ...
                <td class="flex items-center justify-center px-6 py-4 space-x-1">
                    <a class="bg-orange-500 hover:bg-gray-700 text-white font-bold py-2 px-3 ml-2 rounded" href="{{ route('report.show.client', [$report->id]) }}"><i class="fa-solid fa-eye"></i></a>
                </td>
            </tr>
            @endforeach
        </tbody>
