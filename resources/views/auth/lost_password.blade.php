...
@section('content')
    ...
    <div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-md space-y-8 bg-white p-6 rounded drop-shadow-md">
            <div>
                <img class="mx-auto h-12 w-auto" src="{{ asset('img/LogoMagicalMoriak.png') }}" alt="MagicalMoriak">
            ...
            <form class="mt-8 space-y-6" action="{{ route('rememberSend') }}" method="POST">
                ...
                <div class="flex items-center justify-between">
                    <div class="text-sm">
                        <a href="{{ route('index') }}" class="font-medium text-orange-600 hover:text-orange-500">{{__("click-return-to-login")}}
                        </a>
                    </div>
                </div>
