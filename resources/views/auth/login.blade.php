    ...
    <div class="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-md space-y-8 bg-white p-6 rounded drop-shadow-md">
            ...
            <form class="mt-8 space-y-6" action="{{ route('login') }}" method="POST">
                ...
                <div class="-space-y-px rounded-md shadow-sm">
                    <div class="mb-2">
                        ...
                        <input id="email-address" name="email" type="email" value="{{ old('email') }}"
                            ...
                            class="relative block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-purple-500 focus:outline-none focus:ring-orange-500 sm:text-sm"
                ...
                <div>
                    <button type="submit"
                        class="group relative flex w-full justify-center rounded-md border border-transparent bg-teal-600 py-2 px-4 text-sm font-medium text-white hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
