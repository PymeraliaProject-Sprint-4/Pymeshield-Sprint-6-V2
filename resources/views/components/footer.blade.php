<footer class="bg-black text-center lg:text-center mt-auto p-6">
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        <div>
            ...
            <ul>
                <li>
                    <a href="#!" role="button" aria-label="TikTok">
                ...
                <li>
                    <a href="#!" role="button" aria-label="Instagram">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="m-2"><!--! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                    ...
                    <a href="#!" role="button" aria-label="Facebook">
